        ...
        <div className="flex flex-col items-center h-auto bg-[#f4b8af] py-12 w-screen justify-center align-middle">
            <motion.section className="wrap" style={{ height: `${wrapHeight}vh` }} ref={wrapRef}>
                ...
                <div className='flex flex-col md:flex-row flex-wrap'>
                    {Data.map((item, index) => (
                        <motion.div style={{ scale: scale }} key={index} className="object-contain basis-1/2 mx-12 group relative block bg-black w-auto h-[300px] my-6 rounded-lg shadow-2xl shadow-[#d76457] border-[#d76457]">
                            <Image
                                width={300}
                                height={200}
                                alt="Developer"
                            ...
                            <div className="relative p-4 sm:p-6 lg:p-8">
                                ...
                                <div className="mt-32 sm:mt-48 lg:mt-64">
                                    <div className="translate-y-8 transform opacity-0 transition-all ground-hover:-translate-y-8 md:group-hover:-translate-y-32 group-hover:opacity-100">
